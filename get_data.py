...
for record in records:
    ...
    myFeature = Feature(geometry=myPoint, properties={"Organisation":record[0], "City":record[3], "Country":record[4], "Continent":record[5], "Application recieved/announced":record[6]
